...
public class UTreeNode extends DefaultMutableTreeNode implements Serializable ,UComponentI{
	...
	protected UTreeNode parentNode;
	
	protected JMenuItem relatedMenuItem;
	
	protected UMenuInfo menuInfo;
	protected UElementTemplate elementTemplate;
	

	UTemplate template = null;
	public UTreeNode(String content) {
		super(content);
	}
	
	public UTreeNode(int id, String nam, JMenuItem item, UMenuInfo info) {
        super(nam);
        this.name = nam;
	...
	public UTreeNode(Object content) {
		super(content);
	}

	public UTreeNode getParentNode() {
		return parentNode;
	}

	public void setParentNode(UTreeNode parentNode) {
