...
public class UMenuItem extends JMenuItem implements UComponentI {
	...
	public UMenuItem(String name, JMenuItem parentM, UMenuInfo info) {
		super(name);
		parentMenu = parentM;
		menuInfo = info;
	}

	public JMenuItem getParentMenu() {
		return parentMenu;
	}

	public void setParentMenu(UMenuItem parentMenu) {
