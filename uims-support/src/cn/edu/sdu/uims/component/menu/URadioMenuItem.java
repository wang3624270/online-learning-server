...
public class URadioMenuItem extends JRadioButtonMenuItem  implements UComponentI{
	private String componentName;
	private UPanelI parent = null;
	UTemplate template = null;;//added by yxj
	protected UElementTemplate elementTemplate;

	public URadioMenuItem(String text)
	{
		super(text);
	}
	public void init() {
	...
	public void setTemplate(UTemplate template) {
		// TODO Auto-generated method stub
		this.template = template;;//added by yxj
	}
	...
	public UTemplate getTemplate() {
		// TODO Auto-generated method stub
		return this.template;//added by yxj
	}
