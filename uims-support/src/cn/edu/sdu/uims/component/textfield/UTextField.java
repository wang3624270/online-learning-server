...
public class UTextField extends JTextField implements LabeValueTransI,
	...
	public UTextField(int column) {
		super(column);
	}

	public UTextField(String text, int column) {
	}
...
//		this.setBackground(new Color(0,0,0));
	...
	public void sendActionEventToParent(ActionEvent arg0){
		if (containerActionListener != null) {
			ActionEvent e = new ActionEvent(arg0.getSource(),arg0.getID(),this.getComponentName());
...
//				this.addActionListener(getUParent().getEventAdaptor());
	...
	public class DocumentProcessor implements DocumentListener{
		...
		public void sendMessageToUParent(){
			...
			getUParent().getEventAdaptor().processEvent(e, "change", componentName);		
		}
	}
