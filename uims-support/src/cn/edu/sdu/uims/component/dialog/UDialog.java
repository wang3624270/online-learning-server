...
public class UDialog extends JDialog implements UComponentI {
	private UPanelI parent = null;
	private String componentName;
	protected UElementTemplate elementTemplate;
	public UDialog(){
		this(UClientFrame.getInstance(), "", true);
	}
	public UDialog( Dialog owner){
		this(owner, "", true);
	}
	public UDialog(Frame owner, String title, boolean modal)
	{
		super(owner,  title,  modal);
	}
	public UDialog(Dialog owner, String title, boolean modal)
	{
		super(owner,  title,  modal);
	}
