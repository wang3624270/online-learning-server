package cn.edu.sdu.uims.component.hsscanner;
     ...
     super("视频播放程序"); //调用父类构造函数   
      ...
      openFile.addActionListener(new ActionListener() { //打开文件按钮事件处理   
           public void actionPerformed(ActionEvent event) {   
                ...
                int result = fileChooser.showOpenDialog(VideoPlayer.this);//显示对话框       
      ...
      openURL.addActionListener(new ActionListener() { //打开URL按钮事件处理   
       public void actionPerformed(ActionEvent event) {   
        String addressName =JOptionPane.showInputDialog(VideoPlayer.this, "输入URL地址");   
        if (addressName != null)   
