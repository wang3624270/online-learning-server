...
import cn.edu.sdu.uims.graph.model.GElementPolyline;
import cn.edu.sdu.uims.trans.UFRect;

public class XmlElementDataProcessorPolyline extends XmlElementDataProcessor{
	public void getAttributeFromData(double xpoint, double ypoint, double sx,
			double sy, double ra) {
		double dx1, dy1, x1, y1, w, h;
		GElementPolyline ge = (GElementPolyline)gElement;
