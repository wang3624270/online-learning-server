...
public class GElementHistogram3D extends GElementHistogram {
	...
	public GElementHistogram3D(UFRect rec, String label, String label2,
	...
	protected JFreeChart createChart(DefaultCategoryDataset dataset) {
		...
		JFreeChart chart = ChartFactory.createBarChart3D(label, xLabel, yLabel,
