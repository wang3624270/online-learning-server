...
public class CommonBaseDataComboBoxFilterUndergraduateMajor extends UFilter {
	public void init(String parameter) {
		List list = CommonQueryClientUtils.getInstance().getUndergraduateMajorOptionList();
		if(list != null)
