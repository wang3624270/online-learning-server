...
public class HikariProxyConnection extends ProxyConnection implements Wrapper, Connection, AutoCloseable {
	...
	public PreparedStatement prepareStatement(String var1) throws SQLException {
		var1 = GrapeDBSystem.transSQL(var1);
		try {
	...
	protected HikariProxyConnection(PoolEntry var1, Connection var2, FastList var3, ProxyLeakTask var4, long var5,
			boolean var7, boolean var8) {
